...
export class OptionsService {
  ...
  thematicAreas = [
    { name: '01 - General public services', number: 1, active: false, icon: 'road' },
    { name: '02 - Defence', number: 2, active: false, icon: 'shield' },
    { name: '03 - Public order and safety', number: 3, active: false, icon: 'fire-extinguisher' },
    { name: '04 - Economic affairs', number: 4, active: false, icon: 'money' },
    { name: '05 - Environmental protection', number: 5, active: false , icon: 'tree'},
    { name: '06 - Housing and community amenities', number: 6, active: false, icon: 'home' },
    { name: '07 - Health', number: 7, active: false, icon: 'heartbeat' },
    { name: '08 - Recreation, culture and religion', number: 8, active: false, icon: 'glass' },
    { name: '09 - Education', number: 9, active: false, icon: 'graduation-cap' },
    { name: '10 - Social protection', number: 10, active: false, icon: 'street-view' },
  ];
