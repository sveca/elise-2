...
export class OptionsService {
  ...
  thematicAreas = [
    { name: '1 - General public services', number: 1, active: false, icon: 'road', result: 't01' },
    { name: '2 - Defence', number: 2, active: false, icon: 'shield', result: 't02' },
    { name: '3 - Public order and safety', number: 3, active: false, icon: 'fire-extinguisher', result: 't03' },
    { name: '4 - Economic affairs', number: 4, active: false, icon: 'money', result: 't04' },
    { name: '5 - Environmental protection', number: 5, active: false, icon: 'tree', result: 't05' },
    { name: '6 - Housing and community amenities', number: 6, active: false, icon: 'home', result: 't06' },
    { name: '7 - Health', number: 7, active: false, icon: 'heartbeat', result: 't07' },
    { name: '8 - Recreation, culture and religion', number: 8, active: false, icon: 'glass', result: 't08' },
    { name: '9 - Education', number: 9, active: false, icon: 'graduation-cap', result: 't09' },
